...
public class ObjectPool {
	...
	public ObjectPool(GameObject _prefab, int initialCapacity, bool DontDestoryOnLoad)
	{
		pool = new Queue<GameObject>();
		prefab = _prefab;

		GameObject parentGO = new GameObject(prefab.name + " Pool") as GameObject;

		if (DontDestoryOnLoad)
		{
			parentGO.AddComponent<DontDestroy>();
		}
